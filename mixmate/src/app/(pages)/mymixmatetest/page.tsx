...
function MyMixMate() {
  ...
  const handleTabChange = (newValue) => {
    const routes = {
      0: APPLICATION_PAGE.favourites, // Favourites
      1: APPLICATION_PAGE.myRecipes, // My Recipes
      2: APPLICATION_PAGE.social, // Social
      3: APPLICATION_PAGE.myIngredients, // My Ingredients
    };

    router.push(routes[newValue]); // Navigate based on selected tab
